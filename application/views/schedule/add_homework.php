                    ...
                    <div class="card-body">
                        ...
                        <form class="new-added-form" id="form1">
                                ...
                                <div class="col-xl-3 col-lg-6 col-12 form-group">
                                    ...
                                    <input type="hidden" name="type" value="Home Work">
                                ...
                                <div class="col-xl-12 col-lg-12 col-12 form-group">
                                    <label><b>Write home work here *</b></label>
                                    <textarea class="textarea form-control" placeholder="Write class work here..." name="message" id="form-message" cols="10" rows="9"></textarea>
                                </div>
