        ...
        <div class="card-body">
            <div class="row mb-3">
                <div class="col-xl-2 col-lg-6 col-12 arhdng">
                   <h3 class="arm0">Homework List</h3>
                </div>
            ...
            <div class="table-responsive">
                <table class="table display data-table">
                    ...
                    <tbody id="worklist">
                    <?php
                         $this->view2("ajax/allsubjects",$myModel,['wid'=>"25",'type'=>"Home Work",'select'=>"All"]);
                    ?>
                    </tbody>
                </table>
            </div>
...
$("#subjectlist").change(function() {
    ...
    $.ajax({
        ...
        data: {classid:$("#classlist").val().split(',')[0],subjectid:$(this).val().split(',')[0],type:"Home Work",'select':$stype},
        success: function(result){
