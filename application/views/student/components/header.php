...
<head>
    ...
    <?php 
        ...
        $checks  = ['registration','roll_no_generate','save_student','profile_update','mapping_data_update','photo_update','contact_update','student_id_generate','guardian_id_generate','profile_update_random'];
