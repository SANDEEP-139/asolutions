...
if($viewdata["wid"]=="13"){
    ...
    if(empty($viewdata["all"])){
        $myData= $myModel->select_class_students($this->getSession('userid'),$viewdata["status"],$viewdata["clasid"]);
       // $myData= $myModel->update_students($this->getSession('userid'),$viewdata["fathers_name"],$viewdata["mothers_name"],$viewdata
   // ["date_of_birth"]);
    }
    else{
        $myData= $myModel->select_students($this->getSession('userid'),$viewdata["status"]);
    ...
    <tr>
        <td><?php echo $q; ?></td>
        <td class="form-group"><span><?php echo '<input type="hidden" class="idStu" name="id[]" value="'.$myuser->id.'"'; ?> </span><?php echo '<input type="text" name="studentname[]" value="'.$myuser->student_name.'" placeholder="" class="form-control studentName"'; ?></td>
        <td class="form-group"><?php echo '<input type="text" name="fathername[]" value="'.$myuser->fathers_name.'" placeholder="" class="form-control fName"'; ?></td>
        <td class="form-group"><?php echo '<input type="text" name="mother[]" value="'.$myuser->mothers_name.'" placeholder="" class="form-control mName"'; ?></td>
        <td class="form-group"><?php echo '<input type="text" name="date_of_birth[]" value="'.$myuser->date_of_birth.'" placeholder=""  class="dob form-control air-datepicker" />'; ?></td>
        <td class="form-group">
...
if($viewdata["wid"]=="18"){
    ...
    <tr>
        ...
        <td>
            <i onclick="updatebtn('<?php echo $myuser->id ?>')" class="fas fa-edit text-light-sea-green"></i>
            <i onclick="if(confirm('Are you sure, Want to delete?')){ deleted('<?php echo $myuser->id ?>') }" class="fas fa-times-circle text-orange-red"></i>
        </td>
...
if($viewdata["wid"]=="19"){
    $q=0;
    if(!empty($viewdata["search"])){
        if($viewdata["search"]=="Advance"){
            $myData= $myModel->select_transaction_type([$this->getSession('userid'),$viewdata["type"]]);
        }
        else{
            $myData=$myModel->search_transactions($viewdata["query"]);
        }
    }
    else{
    ...
    <tr>
        ...
        <td class="badge badge-pill d-block mg-t-8 <?php if($myuser->payment_type=="Credit"){echo "badge-success";}else if($myuser->payment_type=="Initiate"){echo "badge-success bg-orange-peel";}else {echo "badge-danger";} ?>"><?php if($myuser->payment_type=="Credit"){echo "Credit";}else if($myuser->payment_type=="Advance"){echo "Advance";}else if($myuser->payment_type=="Initiate"){echo "Penalty";}else {echo "Debit";} ?></td>
        <td class="text-center"><img src="<?php echo BASEURL.'/assets/img/figure/admin.jpg' ?>" alt="#"></td>
    </tr>
    <?php
        endforeach;
    }
...
if($viewdata["wid"]=="27"){
    $myData= $myModel->select_class_students($this->getSession('userid'),"Active",$viewdata["clasid"]);
    if(!empty($myData)){
        echo '<option value="0">All Students</option>';
        foreach($myData as $myuser):
            echo '<option value="'.$myuser->id.'">'.$myuser->student_name.'</option>';
        endforeach;
    }
}
if($viewdata["wid"]=="28"){
    ...
    ?>
    <tr>
        <td><?php echo $q; ?><?php echo '<input type="hidden"  name="id[]" value="'.$myuser->id.'"'; ?></td>
        <td class="form-group"><?php echo $myuser->student_name; ?></td>
        <td class="form-group"><?php echo $myuser->fathers_name; ?></td>
        <td class="form-group"><?php echo $myuser->mothers_name; ?></td>
        <td class="form-group"><?php echo '<input type="text" name="date_of_birth[]" value="'.$myuser->lagititude.'" placeholder=""  class="dob form-control air-datepicker" />'; ?></td>
        <td class="form-group"><?php echo '<input type="text" name="date_of_births[]" value="'.$myuser->langititude.'" placeholder=""  class="dob form-control air-datepicker" />'; ?></td>
    </tr>
    <?php
        endforeach;
    }
...
if($viewdata["wid"]=="29"){
    ...
    <tr>
        ...
        <td class="form-group">
        <img style="width:50px;height:50px;float:left;" src="<?php echo BASEURL.$myuser->student_photo; ?>"/>
        <?php echo '<input style="width:90%" type="file" name="fileToUpload[]"  class="form-control" />'; ?></td>
...
if($viewdata["wid"]=="30"){
    ...
    <tr>
        ...
        <td class="form-group"><?php echo '<input type="text" name="mobno[]" value="'.$myuser->father_contact1.'" placeholder=""  class="form-control" />'; ?></td>
        <td class="form-group"><?php echo '<input type="text" name="mobnum[]" value="'.$myuser->sms_contact_no.'" placeholder=""  class="form-control" />'; ?></td>
...
if($viewdata["wid"]=="31"){
    $q=0;
    $myDa= $myModel->select_class($this->getSession('userid'));
    $rltyp=$viewdata["rltype"];
    if(empty($viewdata["all"]) && $viewdata["clasid"]!="0"){
        $myData= $myModel->select_class_students($this->getSession('userid'),$viewdata["status"],$viewdata["clasid"]);
    }
    else{
        $myData= $myModel->select_students($this->getSession('userid'),$viewdata["status"]);
    ...
    <tr>
        ...
        <td class="form-group"><?php echo '<input type="text" name="oldno[]" value="'.$myuser->rollo_number.'" placeholder=""  class="form-control" />'; ?></td>
        <td class="form-group">
        <input <?php if($rltyp=="0"){echo "readonly";} ?> type="text" name="neno[]" value="<?php if($rltyp=="0"){echo $q;}else{echo $myuser->rollo_number;} ?>" class="form-control" />
        </td>
