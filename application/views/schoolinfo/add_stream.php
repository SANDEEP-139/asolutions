    ...
    <div class="card height-auto">
        <div class="card-body">
            <div class="heading-layout1">
                ...
                <div class="dropdown">
                    <button type="button" class="btn-fill-lmd radius-4 text-light bg-light-sea-green">ADD STREAM</button>
                </div>
            </div>
            ...
            <div class="table-responsive">
                <table class="table display data-table">
                    ...
                    ?>
                        <tr>
                            <td><?php echo $q; ?></td>
                            <td><?php echo $myuser->stream_eng; ?></td>
                            <td><?php echo $myuser->stream_hnd; ?></td>
                            <td>
                                <div class="dropdown">
