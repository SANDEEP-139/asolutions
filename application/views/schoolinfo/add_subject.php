        ...
        <div class="card account-settings-box height-auto">
            ...
            <div class="table-responsive">
                <table class="table display data-table">
                    ...
                    <tbody id="da1">
                    <?php
                        $this->view2("ajax/allsubjects",$myModel,['wid'=>"4",'category'=>"Normal"]);
                    ?>
                    </tbody>
                </table>
            </div>
                ...
                <div class="card-body">
                    ...
                    <div class="table-responsive">
                        <table class="table display data-table">
                            ...
                            <tbody id="da2">
                            <?php
                                $this->view2("ajax/allsubjects",$myModel,['wid'=>"4",'category'=>"Practical"]);
                            ?>
                            </tbody>
                        </table>
                    </div>
            ...
            <div class="card account-settings-box">
                <div class="card-body">
                    <div class="heading-layout1 mg-b-20">
                        ...
                        <div class="dropdown">
                            <button type="button" onclick="addbtn('Other Subjects','Other')" class="btn-fill-md radius-30 text-light bg-dark-pastel-green">Add<i class="fas fa-plus mg-l-15"></i></button>
                        </div>
                    </div>
                    <div class="table-responsive">
                        <table class="table display data-table">
                            ...
                            <tbody id="da3">
                            <?php
                                $this->view2("ajax/allsubjects",$myModel,['wid'=>"4",'category'=>"Other"]);
                            ?>
                            </tbody>
                        </table>
                    </div>
