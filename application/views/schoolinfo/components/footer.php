    ...
    $checks  = ['general_info', 'class_section','classwise_subject','student_password'];
    ...
    $checks  = ['examination_type', 'add_stream','add_fee_type','add_discount_type','add_fee_category'];
    if($this->multi_strpos($curl, $checks) !== false){
